...
import { gtsUpdateReportByComponentsZV, gtsVerifyComponentsZvCode } from '../../../../actions/gtsActions';
...
const AddByComponentsZVDialog = (params) => {
  ...
  const handleAdd = () => {
    dispatch(
      gtsUpdateReportByComponentsZV(type === ADD_ONE ? { add_tko: uid } : { selected_all_tko: true }, () => {
  ...
  return (
    <ModalWrapper header={t('ADD_BY_COMPONENTS_ZV_DIALOG_TITLE')} {...params}>
...
export default AddByComponentsZVDialog;
