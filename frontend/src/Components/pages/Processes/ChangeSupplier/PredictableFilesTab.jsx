...
import { downloadProcessFileById, getChangeSupplierPredictableFiles } from '../../../../actions/processesActions';
import { UploadedFilesTable } from '../Components/UploadedFilesTable';
import { Pagination } from '../../../Theme/Table/Pagination';
import useExportFileLog from '../../../../services/actionsLog/useEportFileLog';

const PredictableFilesTab = () => {
  ...
  const handleUpdateList = () => {
    dispatch(getChangeSupplierPredictableFiles(uid, params));
  };
...
export default PredictableFilesTab;
