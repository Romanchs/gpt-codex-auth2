...
import { useRequestCorrectionTSQuery } from '../api';
import { TYPE_AP } from '../../correctionArchivingTS/components/Table';
...
const Table = () => {
  ...
  const { currentData, isFetching } = useRequestCorrectionTSQuery({ uid, params });
