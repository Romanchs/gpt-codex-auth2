...
export const DisputesEntityTkoHistory = ({ disputeEntity }) => {
  ...
  return (
    <>
      <StyledTable>
        ...
        <TableBody>
          {!disputeEntity?.history?.length && <NotResultRow span={12} text={t('STATUSES_HISTORY_NOT_FOUND')} small />}
          {disputeEntity?.history?.map((history, index) => (
