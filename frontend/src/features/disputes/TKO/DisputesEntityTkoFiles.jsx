...
export const DisputesEntityTkoFiles = ({ files }) => {
  ...
  return (
    <>
      <StyledTable>
        ...
        <TableBody>
          {!files?.length && <NotResultRow span={12} text={t('NO_IMPORTED_FILES')} small />}
